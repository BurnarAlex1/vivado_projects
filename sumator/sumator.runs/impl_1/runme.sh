...
HD_PWD='D:/vivado_projects/sumator/sumator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator_8_biti.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumator_8_biti.tcl -notrace
