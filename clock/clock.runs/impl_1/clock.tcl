...
set rc [catch {
  ...
  add_files -quiet D:/vivado_projects/clock/clock.runs/synth_1/clock.dcp
...
set rc [catch {
  ...
  catch { report_drc -file clock_drc_routed.rpt -pb clock_drc_routed.pb -rpx clock_drc_routed.rpx }
  catch { report_methodology -file clock_methodology_drc_routed.rpt -rpx clock_methodology_drc_routed.rpx }
  ...
  catch { report_power -file clock_power_routed.rpt -pb clock_power_summary_routed.pb -rpx clock_power_routed.rpx }
...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile clock.bit 
