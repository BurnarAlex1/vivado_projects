...
HD_PWD='D:/vivado_projects/convertor/convertor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convertor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convertor.tcl
