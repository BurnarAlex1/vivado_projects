...
HD_PWD='D:/vivado_projects/sumator/sumator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumator_8_biti.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumator_8_biti.tcl
