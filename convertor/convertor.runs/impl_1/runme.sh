...
HD_PWD='D:/vivado_projects/convertor/convertor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log convertor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source convertor.tcl -notrace
